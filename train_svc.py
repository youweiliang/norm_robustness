...
from regularization.conv2d_sv import clip_conv, record_input_size
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-freq', '-s', default=1, type=int, metavar='N',
                        help='save frequency')
    parser.add_argument('--clip-freq', default=100, type=int, metavar='N',
                        help='clipping singular values frequency')
    ...
    clip_values= [2.0, 1.5, 1.0, 0.5, 0.1]

    for clip_to in clip_values:
        name = f'{args.model}_conv_sv_{clip_to}'
        print(f'Using {name}')
